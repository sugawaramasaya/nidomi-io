...
import Nidomy from '../..//public/nidomy/nidomy.png';
...
export const ClickToClose = () => {
  ...
  >
    <BackgroundBlur onClick={() => setOpen(false)}>
      <div style={{ background: "#fff", borderRadius: 16, padding: 32, boxShadow: "0 4px 32px rgba(0,0,0,0.12)" }}>
        <h2 style={{ color: "#222", fontWeight: 700, fontSize: 24 }}>クリックで閉じる</h2>
        <p style={{ color: "#444", marginTop: 16 }}>背景をクリックすると消えます。</p>
      </div>
    </BackgroundBlur>
    </div>
  ) : (
